...
export const NLP_PROGRAM_AR = {
  slug: "nlp",
  seo: {
    title: "NLP | البرمجة اللغوية العصبية | Dr. Rana Mosaad",
    description: "البرمجة اللغوية العصبية هي برنامج تدريبي عملي يساعدك على فهم كيف تفكر، كيف تصنع المعنى، كيف تتشكل استجاباتك ومشاعرك، وكيف يمكنك أن تعيد برمجة أنماطك الداخلية لتصل إلى تواصل أقوى، ثقة أكبر، ونتائج أوضح في حياتك وعملك."
  },
  hero: {
    ...
    description_blocks: [
      {
        type: "paragraph",
        text: "البرمجة اللغوية العصبية هي برنامج تدريبي عملي يساعدك على فهم كيف تفكر، كيف تصنع المعنى، كيف تتشكل استجاباتك ومشاعرك، وكيف يمكنك أن تعيد برمجة أنماطك الداخلية لتصل إلى تواصل أقوى، ثقة أكبر، ونتائج أوضح في حياتك وعملك."
      }
    ],
  ...
  pain: {
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "وهنا المشكلة ليست فقط في الظروف…"
      },
      {
        type: "paragraph",
        text: "بل في الطريقة التي يعمل بها برنامجك الداخلي الآن."
      }
    ]
  },
  importance: {
    ...
    content_blocks: [
      {
        type: "paragraph",
        text: "لأن كثيرًا من الناس يعيشون حياتهم بعقلٍ يعمل بشكل تلقائي…"
      },
      {
        type: "paragraph",
        text: "بمعتقدات قديمة، استجابات متكررة، وأنماط لم يختاروها بوعي."
      },
      {
        type: "highlight",
        text: "يفكرون بنفس الطريقة…"
      },
      {
        type: "highlight",
        text: "فيشعرون بنفس الطريقة…"
      },
      {
        type: "highlight",
        text: "فيتصرفون بنفس الطريقة…"
      },
      {
        type: "label",
        text: "ثم يتساءلون: لماذا لا تتغير النتائج؟"
      },
      {
        type: "paragraph",
        text: "NLP يفتح لك هذا العالم من الداخل."
      },
      {
        type: "label",
        text: "يعلمك كيف:"
      ...
      {
        type: "paragraph",
        text: "إذا كنت تريد أن تغيّر حياتك…"
      },
      {
        type: "paragraph",
        text: "فأنت تحتاج أولًا أن تفهم كيف تعمل لغتك، أفكارك، وحالتك من الداخل."
      }
    ]
  },
  transformation: {
    ...
    flows: [
      ...
      {
        from: "اللغة التي تضعفك",
        to: "لغة تدعمك"
      },
      {
        from: "الأنماط القديمة",
        to: "استجابات جديدة أكثر فاعلية"
      },
      {
        from: "التواصل العادي",
        to: "تواصل أكثر تأثيرًا وفهمًا"
      },
      {
        from: "القيادة الخارجية فقط",
        to: "قيادة أعمق للذات والآخر"
      }
    ],
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "ستفهم كيف يعمل عقلك…"
      },
      {
        type: "paragraph",
        text: "وستتعلم كيف تستخدمه لصالحك بدل أن تبقى أسيرًا لبرامجك القديمة."
      }
    ]
  },
  audience: {
  ...
  curriculum: {
    ...
    modules: [
      {
        order: 1,
        title: "كيف يعمل العقل والخبرة الداخلية",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستفهم كيف يصنع الإنسان تجربته من الداخل:\nمن خلال الصور، الأصوات، الإحساس، واللغة."
          }
        ]
      },
      {
        order: 2,
        title: "إدارة الحالة الداخلية",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستتعلم كيف تؤثر حالتك على:"
          },
          {
            type: "bullets",
            items: [
          ...
          {
            type: "paragraph",
            text: "وكيف تغيّر هذه الحالة بوعي."
          }
        ]
      },
      {
        order: 3,
        title: "اللغة وتأثيرها على العقل",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستكتشف كيف تشكل الكلمات المعنى،\n\nوكيف يمكن للغة أن:"
          },
          {
            type: "bullets",
            items: [
      ...
      {
        order: 4,
        title: "بناء Rapport والتواصل المؤثر",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستتعلم كيف تبني اتصالًا أقوى مع الآخرين،\n\nوتفهم أساليبهم في التفكير والتواصل،\n\nوتتواصل معهم بمرونة وتأثير أكبر."
          }
        ]
      },
      {
        order: 5,
        title: "تغيير الأنماط الذهنية والسلوكية",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستتعلم كيف تكتشف الأنماط التي لا تخدمك،\n\nوكيف تبدأ في إعادة برمجتها بأنماط أكثر فاعلية."
          }
        ]
      },
      {
        order: 6,
        title: "المعتقدات والقيم",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستفهم كيف تؤثر معتقداتك وقيمك على اختياراتك،\n\nوكيف تغيّر ما يعطلك منها بطريقة ذكية وعملية."
          }
        ]
      },
      {
        order: 7,
        title: "Anchoring وState Management",
        content_blocks: [
          {
            type: "paragraph",
            text: "ستتعلم كيف تربط حالاتك الداخلية بمحفزات معينة،\n\nوكيف تستدعي حالات مفيدة مثل:"
          },
          {
            type: "bullets",
            items: [
      ...
      },
      {
        ...
        content_blocks: [
          {
            type: "paragraph",
            text: "ستتعلم كيف تغيّر الإطار الذي ترى به الموقف،\n\nوبالتالي تغيّر معناه وتأثيره عليك."
          }
        ]
      },
      {
        ...
        content_blocks: [
          {
            type: "paragraph",
            text: "ستفهم كيف يبني العقل استراتيجياته الداخلية،\n\nمثل:"
          },
          {
            type: "bullets",
            items: [
          ...
          {
            type: "paragraph",
            text: "وستتعلم كيف تغيّر هذه الاستراتيجيات لصالحك."
          }
        ]
      },
      {
  ...
  differentiator: {
    ...
    content_blocks: [
      {
        type: "paragraph",
        text: "لأن هذا البرنامج لا يكتفي بأن يقول لك:"
      },
      {
        type: "quote",
        text: "“فكّر بشكل إيجابي”"
      },
      {
        type: "label",
        text: "أو"
      ...
      {
        type: "paragraph",
        text: "بل يعلمك كيف تتكوّن الحالة أصلًا"
      },
      {
        type: "paragraph",
        text: "وكيف تغيّر بنيتها من الداخل."
      },
      {
        type: "label",
        text: "ما الذي يميّزه؟"
  ...
  why_choose: {
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "NLP ليس مجرد معرفة عن العقل…"
      },
      {
        type: "paragraph",
        text: "بل طريقة عملية لتتعلم كيف تعمل مع عقلك بذكاء أكبر."
      }
    ]
  },
  trainer: {
    ...
    content_blocks: [
      {
        type: "paragraph",
        text: "أنا د. رنا مسعد، وأقدّم هذا البرنامج كرحلة عملية تساعدك على أن تفهم كيف يعمل عالمك الداخلي، وكيف تعيد برمجة أنماطك الذهنية والعاطفية والسلوكية بوعي أكبر."
      },
      {
        type: "paragraph",
        text: "هدفي ليس أن أعطيك مفاهيم فقط…"
      },
      {
        type: "paragraph",
        text: "بل أن أقدّم لك أدوات يمكنك أن تستخدمها:"
      },
      {
        type: "bullets",
        items: [
      ...
      {
        type: "paragraph",
        text: "حتى يتحول الفهم إلى تغيير…"
      },
      {
        type: "paragraph",
        text: "والتغيير إلى نتائج حقيقية."
      }
    ]
  },
  faq: {
    ...
    items: [
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "نعم، إذا تم تقديمه بشكل منظم وواضح، فهو مناسب جدًا للمبتدئ وللمحترف أيضًا."
          }
        ]
      },
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "NLP بطبيعته برنامج عملي جدًا، وقيمته الحقيقية تظهر في التطبيق لا في الفهم فقط."
          }
        ]
      },
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "نعم، كثير من المدربين والكوتشز والقادة يستخدمون NLP كأداة قوية في التواصل والتغيير."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "أنه لا يكتفي بإعطائك نصائح أو تحفيز، بل يعطيك نموذجًا وأدوات عملية لفهم وتغيير البنية الداخلية للخبرة."
          }
        ]
      }
    ]
  ...
  final_cta: {
    ...
    pre_bullets_label: "إذا كنت مستعدًا أن:",
    bullets: [
      "تفهم كيف يعمل عقلك",
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "فربما يكون برنامج NLP هو الخطوة التي تحتاجها الآن."
      }
    ],
    primary_cta: "احجز مكانك في البرنامج"
  },
...
export const NLP_PROGRAM_EN = {
  ...
  pain: {
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "And here, the problem is not only in the circumstances…"
      },
      {
        type: "paragraph",
        text: "It is also in the way your internal programming is working right now."
      }
    ]
  },
  importance: {
    ...
    content_blocks: [
      {
        type: "paragraph",
        text: "Because many people live their lives with a mind that operates automatically…"
      },
      {
        type: "paragraph",
        text: "Through old beliefs, repeated responses, and patterns they never consciously chose."
      },
      {
        type: "highlight",
        text: "They think in the same way…"
      },
      {
        type: "highlight",
        text: "So they feel in the same way…"
      },
      {
        type: "highlight",
        text: "They act in the same way…"
      },
      {
        type: "label",
        text: "Then they wonder: why aren't the results changing?"
      },
      {
        type: "paragraph",
        text: "NLP opens this inner world for you."
      },
      {
        type: "label",
        text: "It teaches you how to:"
      },
      {
        type: "bullets",
        items: [
      ...
      {
        type: "paragraph",
        text: "If you want to change your life…"
      },
      {
        type: "paragraph",
        text: "You first need to understand how your language, thoughts, and internal state work from within."
      }
    ]
  },
  transformation: {
    ...
    flows: [
      {
        ...
        to: "awareness and choice"
      },
      {
        from: "inner distraction",
        to: "clarity of thought"
      },
      {
        from: "language that weakens you",
        to: "language that supports you"
      },
      {
        from: "old patterns",
        to: "new, more effective responses"
      },
      {
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "You will understand how your mind works…"
      },
      {
        type: "paragraph",
        text: "And you will learn how to use it in your favor instead of remaining trapped by your old programming."
      }
    ]
  },
  audience: {
  ...
  curriculum: {
    ...
    modules: [
      {
        order: 1,
        title: "How the Mind and Internal Experience Work",
        content_blocks: [
          {
            type: "paragraph",
            text: "You will understand how people create their experience internally:\nthrough images, sounds, sensations, and language."
          }
        ]
      },
      {
        order: 2,
        title: "Managing Your Internal State",
        content_blocks: [
          {
            type: "paragraph",
            text: "You will learn how your internal state affects:"
          },
          {
            type: "bullets",
            items: [
          ...
          {
            type: "paragraph",
            text: "And how to consciously change that state."
          }
        ]
      },
      {
        order: 3,
        title: "Language and Its Influence on the Mind",
        content_blocks: [
          {
            type: "paragraph",
            text: "You will discover how words shape meaning,\n\nand how language can:"
          },
          {
            type: "bullets",
            items: [
      ...
      {
        order: 4,
        title: "Building Rapport and Influential Communication",
        content_blocks: [
          {
            type: "paragraph",
            text: "You will learn how to build a stronger connection with others,\n\nunderstand their ways of thinking and communicating,\n\nand communicate with them with greater flexibility and influence."
          }
        ]
      },
      {
        order: 5,
        title: "Changing Mental and Behavioral Patterns",
        content_blocks: [
          {
            type: "paragraph",
            text: "You will learn how to identify patterns that no longer serve you,\n\nand how to begin reprogramming them into more effective patterns."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        content_blocks: [
          {
            type: "paragraph",
            text: "You will learn how to connect internal states with specific triggers,\n\nand how to access useful states such as:"
          },
          {
            type: "bullets",
            items: [
      ...
      },
      {
        ...
        content_blocks: [
          {
            type: "paragraph",
            text: "You will learn how to change the frame through which you see a situation,\n\nand therefore change its meaning and its effect on you."
          }
        ]
      },
      {
        ...
        content_blocks: [
          {
            type: "paragraph",
            text: "You will understand how the mind builds its internal strategies,\n\nsuch as:"
          },
          {
            type: "bullets",
            items: [
          ...
          {
            type: "paragraph",
            text: "And you will learn how to change these strategies in your favor."
          }
        ]
      },
      {
  ...
  differentiator: {
    ...
    content_blocks: [
      {
        type: "paragraph",
        text: "Because this program does not simply tell you:"
      },
      {
        type: "quote",
      ...
      {
        type: "quote",
        text: "“Be more confident”"
      },
      {
        type: "paragraph",
        text: "Instead, it teaches you how the state is formed in the first place"
      },
      {
        type: "paragraph",
        text: "and how to change its structure from within."
      },
      {
        type: "label",
  ...
  why_choose: {
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "NLP is not simply knowledge about the mind…"
      },
      {
        type: "paragraph",
        text: "It is a practical way to learn how to work with your mind more intelligently."
      }
    ]
  },
  trainer: {
    ...
    content_blocks: [
      {
        type: "paragraph",
        text: "I am Dr. Rana Mosaad, and I present this program as a practical journey that helps you understand how your inner world works and how to reprogram your mental, emotional, and behavioral patterns with greater awareness."
      },
      {
        type: "paragraph",
        text: "My goal is not simply to give you concepts…"
      },
      {
        type: "paragraph",
        text: "But to give you tools you can use:"
      },
      {
        type: "bullets",
        items: [
      ...
      {
        type: "paragraph",
        text: "So understanding turns into change…"
      },
      {
        type: "paragraph",
        text: "And change turns into real results."
      }
    ]
  },
  faq: {
    ...
    items: [
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "Yes. When it is presented in a clear and structured way, it is highly suitable for beginners as well as professionals."
          }
        ]
      },
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "NLP is highly practical by nature, and its real value appears in application, not only in understanding."
          }
        ]
      },
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "Yes. Many trainers, coaches, and leaders use NLP as a powerful tool for communication and change."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        answer_blocks: [
          {
            type: "paragraph",
            text: "It does not simply give you advice or motivation. It gives you a model and practical tools for understanding and changing the internal structure of experience."
          }
        ]
      }
    ]
  ...
  final_cta: {
    heading: "Start Your Journey of Understanding and Reprogramming Your Inner World Now",
    pre_bullets_label: "If you are ready to:",
    bullets: [
    ...
    closing_blocks: [
      {
        type: "paragraph",
        text: "Then the NLP program may be the step you need right now."
      }
    ],
    primary_cta: "Reserve Your Spot in the Program"
  },
