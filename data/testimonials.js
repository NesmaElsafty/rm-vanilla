...
export const testimonials = [
  ...
  },
  {
    ...
    content: {
      ar: 'برنامج يعيد صياغة صورتك الذهنية اللاوعية عن نفسك إلى صورة مضيئة وأكثر إشراقًا مما يغذّي شعور الثقة بالنفس والطمأنينة تجاه القادم، ويساعدك على اجتذاب فرص أفضل وعلاقات أرقى وأكثر وعيًا تناسب مساحة الاستقبال الخاصة بنسختك المنشودة.',
      en: 'A program that reshapes your subconscious self-image into a brighter, more radiant picture — nourishing self-confidence and peace about what lies ahead, and helping you attract better opportunities and more conscious, elevated relationships that fit the space your desired self is ready to receive.',
    },
  ...
  },
  {
    ...
    rating: 5,
    name: { ar: 'بشائر كريم', en: 'Bashayer Karim' },
    role: {
      ar: 'ربة منزل وطالبة بكالوريوس · العراق',
      en: "Homemaker & Bachelor's Student · Iraq",
    },
    content: {
      ar: 'أخذت تقريبًا أكثر من كورس مع دكتورة رنا ومن أبرزها أنا أنثى وبرنامج APG. كان تأثيرهم على حياتي عظيم؛ عرفت أتعامل مع مشاعري وأديرها، قدرت أستعيد ملكيتي لنفسي وقيادة ذاتي، عرفت إمكانياتي وقيمتي كإنسان. ودكتورة رنا من أكثر المدربين اللي أثق بيهم وبمعلوماتهم؛ حقيقية وصادقة بطرح المعلومة وأسلوبها سهل ومنظم. أشكر نفسي إني اخترت تكون مدربتي وأتطور من خلال ما تقدمه.',
      en: 'I have taken more than one course with Dr. Rana, most notably I Am Female and the APG program. Their impact on my life has been tremendous. I learned how to deal with my emotions and manage them, regained ownership of myself and self-leadership, and discovered my capabilities and value as a human being. Dr. Rana is among the trainers I trust most and whose knowledge I believe in — genuine and honest in how she presents information, with an easy and organized style. I thank myself for choosing her as my coach and for growing through what she offers.',
    },
  ...
  },
  {
    ...
    content: {
      ar: 'درست مع د. رنا كورس أنا أنثى وكورس الثقة بالنفس وبرنامج ديتوكس وبرنامج متصل ومبادرة مطمئن كل جمعة. د. رنا من أكثر المدربين المؤثرين فعلاً؛ كل كورس ترك بصمات قوية في حياتي وغيّرني ولله الحمد تغييراً جذرياً. شكراً لعطائك وخبرتك وتنظيمك وسلاسة أسلوبك وصدقك في كل كلمة، شكراً من القلب ❤️ ❤️',
      en: 'I studied with Dr. Rana in the I Am Female course, the self-confidence course, the Detox program, the Mottasel program, and the Motmain initiative every Friday. Dr. Rana is truly one of the most impactful trainers; every course left a strong mark on my life and changed me, praise be to Allah, in a radical way. Thank you for your giving, expertise, organization, smooth style, and honesty in every word — thank you from the heart ❤️ ❤️',
    },
    programTaken: {
  ...
  },
  {
    ...
    content: {
      ar: 'برنامج أنا أنثى، نسخته الأولى، وبالنسبة لي كانت نقلة في التواصل مع نفسي ومع أنوثتي واتحاد الذكورة جوايا والتوازن ما بينهم 😍',
      en: 'The I Am Female program — the first edition — was, for me, a turning point in how I connect with myself, with my femininity, and with the masculine energy within me, and in finding balance between them 😍',
    },
