...
export const translations = {
  ar: {
    ...
    hero: {
      ...
      subtitle:
        'بساعدك على التحرر من الشك الداخلي، الاحتياج العاطفي، والانفصال عن الذات، والعودة إلى قيمتك واتصالك الحقيقي بالله، حتى تعيش بسلام داخلي وتمكين ومتعة.',
    ...
    contact: {
      ...
      messagePlaceholder: 'اكتب هنا تطلعاتك أو ما تودّ التركيز عليه في الجلسة...',
      submit: 'إرسال عبر واتساب',
      confirmWhatsapp: 'تأكيد الإرسال عبر الواتساب',
      successTitle: 'شكراً لتواصلك معنا!',
      successMessage:
        'تم تجهيز رسالتك. افتح واتساب لإرسال الطلب. سنرد خلال 24 ساعة لجدولة موعدك.',
  ...
  en: {
    ...
    stats: {
      ...
      l2: 'Beneficiaries',
      l3: 'Deep transformational programs',
    },
    philosophy: {
    ...
    aboutPage: {
      ...
      snapshot: [
        ...
        { label: 'Impact', value: '+5000 beneficiaries' },
      ...
      impactTitle: 'Impact',
      statsStudentsLabel: 'Beneficiaries',
